...
<div class="flex grow h-full w-72 flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
				...
				<ul role="list" class="-mx-2 space-y-1">
					...
					<li>
						<div>
							...
							<ul class="{open ? 'block' : 'hidden'} mt-1 px-2" id="sub-menu-1">
								<li>
									<!-- 44px -->
									<a href="#" class="hover:bg-gray-50 block rounded-md py-2 pr-2 pl-9 text-sm leading-6 text-gray-700"
										>Engineering</a
									>
								</li>
								<li>
					...
					<li>
						<div>
							...
							>
								...
								<!-- Expanded: "rotate-90 text-gray-500", Collapsed: "text-gray-400" -->
								<svg
									class="{open_two ? 'rotate-90 text-gray-500' : 'text-gray-400'} ml-auto h-5 w-5 shrink-0"
									viewBox="0 0 20 20"
									fill="currentColor"
									aria-hidden="true"
								>
							...
							<!-- Expandable link section, show/hide based on state. -->
							<ul class="{open_two ? 'block' : 'hidden'} mt-1 px-2" id="sub-menu-2">
								<li>
									<!-- 44px -->
									<a href="#" class="hover:bg-gray-50 block rounded-md py-2 pr-2 pl-9 text-sm leading-6 text-gray-700"
										>GraphQL API</a
